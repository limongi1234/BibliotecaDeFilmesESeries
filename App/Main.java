		...
		do {
		     try {
				...
				case 3:
					...
					if (listaPrograma.isEmpty()) {
						System.out.println(
								"Impossível remover programas de uma lista vazia! Pressione uma tecla para voltar: ");
						leia.next();
						break;
					}
					for (Programa programa : listaPrograma) {
						if (programa.getNome().equalsIgnoreCase(nome)) {
							...
							if (opt == 1) {
								...
								System.out.println("Programa excluído com sucesso! Pressione uma tecla para voltar: ");
								leia.next();
								break;
							} else if (opt == 2) {
								System.out
				...
				case 6:
					System.out.println("\n\"É preciso que o discípulo da sabedoria tenha o coração grande e corajoso. "
							+ "O fardo é pesado e a viagem longa.\" - Confúcio.\n\nEncerrando o programa. Até mais!");
					sair = true;
				}
